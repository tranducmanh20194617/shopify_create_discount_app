...
export class ExtensionInstance {
    ...
    async deployConfig({ apiKey, developerPlatformClient, }) {
        if (this.isFunctionExtension)
            return this.functionDeployConfig({ apiKey, developerPlatformClient });
        return this.commonDeployConfig(apiKey);
    }
    async functionDeployConfig({ apiKey, developerPlatformClient, }) {
    ...
    async bundleConfig({ identifiers, developerPlatformClient, apiKey }) {
