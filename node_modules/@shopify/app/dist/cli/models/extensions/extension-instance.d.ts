...
export declare class ExtensionInstance<TConfiguration extends BaseConfigType = BaseConfigType> {
    ...
    deployConfig({ apiKey, developerPlatformClient, }: ExtensionDeployConfigOptions): Promise<{
        [key: string]: unknown;
    } | undefined>;
    functionDeployConfig({ apiKey, developerPlatformClient, }: ExtensionDeployConfigOptions): Promise<{
        [key: string]: unknown;
    } | undefined>;
    ...
    get watchBuildPaths(): string[] | null;
    watchConfigurationPaths(): Promise<string[]>;
    ...
    bundleConfig({ identifiers, developerPlatformClient, apiKey }: ExtensionBundleConfigOptions): Promise<{
