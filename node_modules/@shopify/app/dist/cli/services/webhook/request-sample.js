 ...
 */
export async function getWebhookSample(developerPlatformClient, variables) {
    const { sendSampleWebhook: result } = await developerPlatformClient.sendSampleWebhook(variables);
    return result;
}
