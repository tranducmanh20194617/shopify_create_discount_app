...
Deploy.descriptionWithMarkdown = `[Builds the app](https://shopify.dev/docs/apps/tools/cli/commands#build), then deploys your app configuration and extensions.
  ...
  `;
Deploy.description = _a.descriptionWithoutMarkdown();
Deploy.flags = {
    ...globalFlags,
    ...appFlags,
