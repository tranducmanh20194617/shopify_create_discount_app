...
_a = ConfigUse;
ConfigUse.summary = 'Activate an app configuration.';
ConfigUse.descriptionWithMarkdown = `Sets default configuration when you run app-related CLI commands. If you omit the \`config-name\` parameter, then you'll be prompted to choose from the configuration files in your project.`;
ConfigUse.description = _a.descriptionWithoutMarkdown();
ConfigUse.flags = {
    ...globalFlags,
