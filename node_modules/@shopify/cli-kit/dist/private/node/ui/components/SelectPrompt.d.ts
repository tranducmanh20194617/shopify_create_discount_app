...
declare function SelectPrompt<T>({ message, choices, infoTable, infoMessage, onSubmit, defaultValue, abortSignal, }: React.PropsWithChildren<SelectPromptProps<T>>): ReactElement | null;
export { SelectPrompt };
