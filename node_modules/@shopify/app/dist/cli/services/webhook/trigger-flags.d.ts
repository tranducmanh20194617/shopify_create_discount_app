 ...
 */
export declare function parseVersionAndTopic(developerPlatformClient: DeveloperPlatformClient, flags: WebhookTriggerFlags): Promise<[string | undefined, string | undefined]>;
/**
