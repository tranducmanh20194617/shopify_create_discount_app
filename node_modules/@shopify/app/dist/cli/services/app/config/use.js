...
export default async function use({ directory, configName, warningContent, shouldRenderSuccess = true, reset = false, developerPlatformClient = selectDeveloperPlatformClient(), }) {
    if (reset) {
...
async function logMetadata(configuration, developerPlatformClient) {
