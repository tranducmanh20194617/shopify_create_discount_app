 ...
 */
export declare function selectStore(stores: OrganizationStore[], org: Organization, developerPlatformClient: DeveloperPlatformClient): Promise<OrganizationStore>;
/**
 ...
 */
export declare function convertToTestStoreIfNeeded(store: OrganizationStore, orgId: string, developerPlatformClient: DeveloperPlatformClient): Promise<void>;
/**
 ...
 * @param developerPlatformClient - The client to access the platform API
 */
export declare function convertStoreToTest(store: OrganizationStore, orgId: string, developerPlatformClient: DeveloperPlatformClient): Promise<void>;
