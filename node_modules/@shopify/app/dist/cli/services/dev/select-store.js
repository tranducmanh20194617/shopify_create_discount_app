 ...
 */
export async function selectStore(stores, org, developerPlatformClient) {
 ...
 */
async function waitForCreatedStore(orgId, developerPlatformClient) {
    const retries = 10;
 ...
 */
export async function convertToTestStoreIfNeeded(store, orgId, developerPlatformClient) {
    /**
    ...
    if (!store.transferDisabled)
        await convertStoreToTest(store, orgId, developerPlatformClient);
}
/**
 ...
 * @param developerPlatformClient - The client to access the platform API
 */
export async function convertStoreToTest(store, orgId, developerPlatformClient) {
    const variables = {
        input: {
    ...
    const result = await developerPlatformClient.convertToTestStore(variables);
