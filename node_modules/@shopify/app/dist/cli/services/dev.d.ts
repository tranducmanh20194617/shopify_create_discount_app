...
export declare function developerPreviewController(apiKey: string, developerPlatformClient: DeveloperPlatformClient): DeveloperPreviewController;
...
export declare function validateCustomPorts(webConfigs: Web[], graphiqlPort: number): Promise<void>;
