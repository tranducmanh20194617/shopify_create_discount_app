...
export async function webhookTriggerService(flags) {
    ...
    const options = await collectMissingFlags(developerPlatformClient, validFlags);
...
async function validatedFlags(flags) {
    ...
    const developerPlatformClient = flags.developerPlatformClient ?? selectDeveloperPlatformClient();
...
async function collectMissingFlags(developerPlatformClient, flags) {
...
async function sendSample(developerPlatformClient, options) {
    const variables = {
        topic: options.topic,
