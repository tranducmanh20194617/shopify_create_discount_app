 ...
 */
export async function fetchSpecifications({ developerPlatformClient, apiKey, }) {
    const result = await developerPlatformClient.specifications(apiKey);
    const extensionSpecifications = result
