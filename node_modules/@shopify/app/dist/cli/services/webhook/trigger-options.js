 ...
 */
export async function collectCredentials(developerPlatformClient, secret) {
 ...
 */
export async function collectApiKey(developerPlatformClient) {
    const localCredentials = await findInEnv();
 ...
 * @returns api-version
 */
export async function collectApiVersion(developerPlatformClient, apiVersion) {
 ...
 * @returns topic
 */
export async function collectTopic(developerPlatformClient, apiVersion, topic) {
    if (isValueSet(topic)) {
